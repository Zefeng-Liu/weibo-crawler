    ...
    def process_item(self, item, spider):
        ...
        if isinstance(item, RelationshipsItem):
            ...
            try:
                ...
                sql = ''
                sql+=str('INSERT INTO weibotest.users (`user_id`,`nick_name`,`gender`,`province`,`city`,`signature`,`birthday`,`num_tweets`,`num_follows`,`num_fans`,`sex_orientation`,`marriage`,`url`) ')
                sql+=str(' Values(\'' )
                sql+=str(item['_id'])
